...
**Важное примечание:** Скрипты на SQF примерно в 40 раз медленнее, чем JavaScript. Однако это не означает, что нужно оптимизировать весь код - производительность критически важна только в определенных местах:
