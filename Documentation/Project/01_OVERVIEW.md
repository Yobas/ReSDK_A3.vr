...
- **Платформа**: Arma 3 Engine (Real Virtuality Engine) - в документации обозначается как "Платформа"
...
- Порядок обработки RPC сообщений может отличаться от порядка отправки
...
**Сервис обновления:**
- Автоматическая сборка происходит только для релизных версий
- Dev-версии требуют ручной сборки
