...
Проект собирается **сервисом обновления**, который отслеживает коммиты и релизы в репозитории:
...
- Файл хранится на сервере сервиса обновлений и автоматически копируется в репозиторий при сборке
- Файл попадает в билд, когда сервис обновлений собирает проект через remaker
...
GitHub Actions автоматически создает draft релиза через Release Drafter:
