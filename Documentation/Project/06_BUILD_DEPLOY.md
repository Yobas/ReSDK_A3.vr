...
Проект собирается **сервисом обновления**, который отслеживает коммиты и релизы в репозитории GitHub:
...
RBuilder - это утилита для препроцессинга и упаковки SQF кода в форматы, необходимые для Arma 3.
